                ...
                @if(isset($data))
                  ...
                  <tr>
                    ...
                    <td style="margin-right: 20px;">
                      <a href="{{route('notice.edit', $value->id)}}"><button class="btn btn-primary   pull-left" title="edit EmployeeData"><i class="fa fa-edit" ></i></button></a>

                                <form  method="POST" action="{{route('notice.destroy',$value->id)}}" onclick="return confirm('Are you sure you want to delete this notice?')">
                                              @csrf
                                              @method('delete')
